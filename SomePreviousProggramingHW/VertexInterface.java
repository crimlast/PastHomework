...
//
// Description:
//  An interface for Vertex on a graph.
//
...
public interface VertexInterface<T>{ 
    ...
    /** Gets a vertex and edge and if it is in the list, it will remove it
     * @param endVertex vertex which has an already existing connection with the vertex.
